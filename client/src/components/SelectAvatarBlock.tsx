...
const SelectAvatarBlock = ({ id, imgSrc, error }: SelectAvatarBlockProps) => {
    ...
    return (
        <div className="mb-7">
            <label className="font-bold inline-block dark:text-white" htmlFor={id}>Avatar</label>
            <div className="py-1 flex items-center gap-x-6">
                ...
                <div className="flex-1 flex flex-col">
                    <input
                        ...
                        file:mr-2 file:py-2 file:px-4 file:bg-inherit file:border file:border-stripe-500 file:rounded-full file:font-bold file:text-stripe-500 
                        file:hover:cursor-pointer dark:file:hover:bg-stripe-500/20"
                        id={id}
