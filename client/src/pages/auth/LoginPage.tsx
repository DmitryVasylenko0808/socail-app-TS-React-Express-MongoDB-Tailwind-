...
const LoginPage = () => {
  ...
  return (
    <form onSubmit={onSignInHandle}>
      <h2 className="mb-7 font-bold text-center text-2xl">Sign In</h2>
      ...
      <button 
        type="submit" 
        className="w-full py-3 bg-stripe-400 rounded-full text-white font-bold hover:bg-stripe-500 disabled:opacity-50 disabled:cursor-auto hover:disabled:bg-stripe-400"
        disabled={isLoading}
      >
